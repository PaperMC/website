...
The official [PaperMC](https://papermc.io) website — built with **Astro 6**, powered by **pnpm**, and styled using **Tailwind CSS v4**. Content in this repository is published to [papermc.io](https://papermc.io) for viewing.
