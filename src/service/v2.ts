...
export const getVersionBuilds = (project: string, version: string): Promise<VersionBuilds> =>
  getJSON(`/projects/${project}/versions/${version}/builds`);

export const getVersionBuildDownloadURL = (project: string, version: string, build: number, file: string): string =>
