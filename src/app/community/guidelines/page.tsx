    ...
    <>
      ...
      <section id="overview" className="px-4 py-4 max-w-7xl mx-auto leading-7">
        ...
        <p>
          ...
          mind, we need to be proactive and explicit about how we intend to
          combat negativity and toxicity in the PaperMC community. We want
          PaperMC to be a welcoming community to all, where new members feel
          safe to hang out and ask questions, and where old members are happy to
          hang out, chat, and help others too. We want PaperMC to be an
          inclusive environment. PaperMC is, at its core, a development
          community. We want to continue staying focused on being a development
          community rather than letting toxic behavior take over. This document
          is the definitive list of guidelines everyone in the community must
          follow to participate in this community.
        </p>
      </section>
      <section
      ...
      >
        ...
        <p>
          This document uses the phrase &quot;PaperMC community&quot; to refer
          to all communication which happens within the PaperMC ecosystem. This
      ...
      >
        ...
        <p>
          We do this because creating an exhaustive list for all negative
          behavior we want to avoid is impossible and likely won&apos;t help
          anyways. The kinds of people who would engage in such a way in the
          first place probably aren&apos;t the people we want around at all.
          <br />
          <br />
          However, there are specific behaviors we want to avoid in our
          community. The following behaviors are not permitted in the PaperMC
          community:
        </p>
        <ol className="list-decimal list-inside my-4 ml-4 space-y-2 py-1">
              ...
              <li>
                ...
                <ol className="list-[lower-roman] list-inside ml-6 space-y-2 py-1">
                  <li>
                    ...
                    question is no longer current and the conversation has
                    changed is fine, as long as it&apos;s not too repetitive.
                  </li>
                  <li>
          ...
          <li>
            ...
            <ol className="list-alpha list-inside ml-6 space-y-2 py-1">
              <li>
                Non-hateful and non-bigoted cursing is fine for the most part,
                but not in usernames. Constant cursing in every message
                isn&apos;t allowed. Usernames containing curse words are
                basically the same as saying that word every time a message is
                sent, so it&apos;s the same problem.
              </li>
              <li>
                Impersonating people includes anyone in or out of the server,
                not just staff and not just those in Paper.
              </li>
              <li>
                Putting servers or plugins in usernames isn&apos;t allowed.
                However, this is allowed in less visible fields, such as a
                Discord status.
              </li>
              <li>
          ...
          <li>
            ...
            <ol className="list-alpha list-inside ml-6 space-y-2 py-1">
              ...
              <li>
                Someone pinging a particular person because they are responding
                to that person isn&apos;t a problem. Someone pinging a project
                developer or contributor just because they want an answer is
          ...
          <li>
            ...
            <ol className="list-alpha list-inside ml-6 space-y-2 py-1">
              <li>
                This does not apply to legitimate uses of offline mode, like
                with certain proxies, as long as the users get authenticated
                with Microsoft another way.
              </li>
            </ol>
          </li>
          <li>
            Discussing the bypassing or exploiting of Minecraft&apos;s player
            safety features in any way that is malicious or harmful. This
            applies to discussion around how to bypass chat, username, and skin
            reporting specifically, as well as any other features that make
            Minecraft a safer place for its users.
            <ol className="list-alpha list-inside ml-6 space-y-2 py-1">
              <li>
        ...
        <p>
          ...
          ping on Discord to notify the moderation team. You can also contact
          the team privately using the <code>/modmail</code> command, however
          this does not alert us in the same way that the <code>@mods</code>{" "}
          ping does, so don&apos;t use it for time sensitive issues.
        </p>
      </section>
      <section
      ...
      >
        ...
        <p>
          Particularly severe issues represent a behavior and a kind of person
          we don&apos;t want associated with PaperMC in any way. These behaviors
        ...
        <p>
          This list is not exhaustive. If someone is engaging in bad behavior
          not conducive to a friendly environment, and we believe it warrants an
      ...
      >
        ...
        <p>
          PaperMC has channels dedicated to specific topics, and conversations
          in these channels should stay on-topic. This can help newer members in
        ...
        <p>
          Moderators will shut down any off-topic discussions happening in any
          of the following channels and ask for the conversation to be moved to{" "}
      ...
      >
        ...
        <p>
          ...
          and <code>#hangar-help</code> are there for people who need support
          using our software. While we are very happy that so many members of
          the community actively support there and answer questions, please make
          sure to follow our guidelines there as well. Many people that go there
          to ask questions are new to Minecraft servers and to the community
          itself. We should be welcoming towards newcomers, especially since we
          all started somewhere. In general, &quot;Rule 1: Don&apos;t be a
          jerk&quot; applies here as well, but we would like to add the
          following points:
        </p>
        <ol className="list-decimal list-inside my-4 ml-4 space-y-2">
          <li>
            Please don&apos;t harass people for using software/plugins that you
            don&apos;t like. We know that some plugins are not that well
            received in this community, but as long as they are not causing the
            issue itself, you shouldn&apos;t harass people for using them. This
            doesn&apos;t mean that you can&apos;t recommend a replacement.
            Again, as stated in rule 1, if you don&apos;t like if someone is
            using a specific software, you can always choose to just ignore the
            question and let someone else answer.
          </li>
          <li>
            ...
            likely to change. We generally discourage people from using our
            older software, and we stipulate that it comes with no support. This
            does not mean users asking for support for older versions should be
            mocked or yelled at, however.
          </li>
        </ol>
      </section>
      <section
      ...
      >
        ...
        <p>
          If you have been banned on our Discord server, we offer a way to
          appeal that ban. To do that, simply join{" "}
          <a
            className="text-blue-800 dark:text-blue-300"
