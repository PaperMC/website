      ...
      <header className="max-w-7xl flex flex-row mx-auto px-4 pt-32 pb-16 lg:pt-48 lg:pb-32 gap-16">
        <div className="flex-1">
          ...
          <p className="text-xl mt-4">
            Our projects are based on community contributions and wouldn&apos;t
            be possible without them. There are a lot of ways to contribute,
      ...
      >
        <div className="lg:flex-1">
          ...
          <p className="md:mt-6 md:text-lg text-gray-900 dark:text-gray-100 mt-3">
            ...
            answer questions or provide support, whether on our Discord server
            or in our forums
          </p>
          <div className="flex flex-row gap-4 mt-8">
