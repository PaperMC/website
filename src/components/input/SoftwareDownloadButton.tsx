...
const SoftwareDownloadButton = () => {
  ...
  return (
    <a
      ...
      target="_blank"
      href={project && latestBuild && getVersionBuildDownloadURL(selectedProject, project.latestVersion, latestBuild.build, latestBuild.downloads["application"].name)}
      rel="noreferrer"
    >
      ...
      <div className="text-left">
        <span className="font-medium text-lg">
          {project && builds ? `${project.name} Build ${latestBuild?.build}` : "Loading..."}
        </span>
