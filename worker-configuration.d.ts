/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ec36602ee029116c34a130f2c0cffb96)
// Runtime types generated with workerd@1.20260708.1 2026-02-19 disable_nodejs_process_v2,nodejs_compat
interface __BaseEnv_Env {
	WEBSITE_CACHE: KVNamespace;
	ASSETS: Fetcher;
	FILL_WEBHOOK_SECRET: string;
	DOWNLOAD_UPDATES: DurableObjectNamespace<import("./src/worker").DownloadsUpdateCoordinator>;
	DOWNLOAD_CLIENTS: DurableObjectNamespace<import("./src/worker").DownloadsWebSocketShard>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "DownloadsUpdateCoordinator" | "DownloadsWebSocketShard";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FILL_WEBHOOK_SECRET">> {}
}
